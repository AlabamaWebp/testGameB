...
createClass(
    "Волшебник",
    "Полёт: Можешь сбросить до 3 карт после смывки, каждая тебе прибавит + 1 на смывку," +
    "Усмирение: Сбрось всю руку (не меньше 3 карт) чтобы усмирить монстра (он отдаёт сокровища, но не уровень)",
    {}, 2
)
createClass(
    "Суперманчкин",
